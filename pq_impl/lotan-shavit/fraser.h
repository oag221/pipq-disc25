...
//#include "../lotan-shavit/ssalloc.h"
...
inline uintptr_t unset_mark(uintptr_t i) { return (i & ~(uintptr_t)0x01); }
inline uintptr_t set_mark(uintptr_t i);
void fraser_search(sl_intset_t *set, slkey_t key, sl_node_t **left_list,
