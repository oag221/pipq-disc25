...
int sl_contains_val(sl_intset_t *set, slkey_t key, val_t *val, int) {
...
int sl_add_val(sl_intset_t *set, slkey_t key, val_t val, int) {
...
int sl_remove_val(sl_intset_t *set, slkey_t key, val_t *val, int) {
...
int sl_remove_succ_val(sl_intset_t *set, slkey_t key, val_t *val, int) {
